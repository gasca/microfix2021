    ...
    <tr>
      ...
      <td>
						...
						<form action="{{ route('users.destroy', $user) }}" method="POST">
							...
							<a href="{{ route('users.show', $user) }}" class="btn btn-link"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-eye-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
