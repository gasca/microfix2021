...
<table class="table table-dark" >
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo e($user->ap_paterno); ?></td>
      <td><?php echo e($user->ap_materno); ?></td>
      <td>
              ...
              <?php echo method_field('DELETE'); ?>
               ...
               class="btn btn-link"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-eye-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path fill-rule="evenodd" d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
						...
						<a href="<?php echo e(route('users.edit', $user)); ?>" class="btn btn-link"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\microfix2021\resources\views/users/index.blade.php ENDPATH**/ ?>