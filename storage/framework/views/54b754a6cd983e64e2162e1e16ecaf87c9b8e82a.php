...
<form
  ...
  <div class="form-group">
		...
		<input type="text" name="nombre" class="form-control"  placeholder="" value= "<?php echo e('Jesus', old('nombre')); ?>">
    ...
    <div class="form-group">
		...
		<input type="text" name="ap_paterno" class="form-control"  placeholder="" value= "<?php echo e('Gasca', old('ap_paterno')); ?>">
   ...
   <div class="form-group">
		...
		<input type="text" name="ap_materno" class="form-control"  placeholder="" value= "<?php echo e('Belman', old('ap_materno')); ?>">
  ...
  <div class="form-group">
	...
	<input type="text" name="curp" class="form-control"  placeholder="" value= "<?php echo e('123344', old('curp')); ?>">
...
<div class="form-group">
		...
		<input type="text" name="domicilio" class="form-control" placeholder=""   value= "<?php echo e('sssss', old('domicilio')); ?>">
  ...
  <div class="form-group">
		...
		<input type="text" name="codigo_postal" class="form-control" placeholder=""   value= "<?php echo e('38240', old('codigo_postal')); ?>">
   ...
   <div class="form-group">
		...
		<input type="input" name="telefono" class="form-control"  placeholder="" value= "<?php echo e('42121212', old('telefono')); ?>" >
  	...
  	<div class="form-group">
		...
		<input type="text" name="correo" class="form-control" placeholder="" value= "<?php echo e('hola@hotmail.com', old('correo')); ?>">
