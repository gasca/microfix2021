...
class CreateReporteComputadorasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reporte_computadoras', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('reporte_computadoras');
    }
}
